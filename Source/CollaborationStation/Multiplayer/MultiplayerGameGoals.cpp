...
//
#include "MultiplayerGameGoals.h"

int32 UMultiplayerGameGoals::ComputeGoal(int32 Round, int32 Players)
{
	check(Round - 1 < Points.Num() && "Round must be valid");
	return Points[Round - 1] * Players;
}
