...
#include "SlidingTileGameMode.generated.h"

/**
 * 
 */
UCLASS()
class COLLABORATIONSTATION_API ASlidingTileGameMode : public AMinigameGameMode
{
	GENERATED_BODY()

protected:
	UFUNCTION(BlueprintCallable, BlueprintPure)
	TArray<class UPaperSprite*> LoadTiles(FString PathPrefix);
